...
#INCLUDE <Functions>
delete("shell.txt"),Title:="ShellHook Messages",Filters:="",Pause:=0,cmd:="",FilterMenu(),Gui(),Hwnd:=WinExist(),WM_VSCROLL:= 0x115,SB_BOTTOM:=7
...
Gui(){
	Global
	Gui, +LastFound +Resize ; +ToolWindow
	Gui, Margin, 0, 0
	Gui, Font, s8, Microsoft Sans Serif
	Gui, Color,, DEDEDE
	Gui, Add, ListView, w800 r10 vData +Grid , lParam (hWnd)|Process|wParam|Message|Title|CMD
