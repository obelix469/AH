...
; token:=Gdip_Startup()
URL(T="A"){
return sURL:=GetActiveBrowserURL(T)
}linkify(link){
return ret:="<a href=""" . link . """>" . link . "</a>"
}
GetActiveBrowserURL(T="A") {
if t=""
return
	WinGetClass, sClass, % T
If sClass In IEFrame,ApplicationFrameWindow,MozillaWindowClass,OperaWindowClass,Chrome_WidgetWin_0,Chrome_WidgetWin_1,Chrome_WidgetWin_2,Chrome_WidgetWin_3,Slimjet_WidgetWin_1,Maxthon3Cls_MainFrm
