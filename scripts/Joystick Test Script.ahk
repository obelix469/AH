...
Loop
{
	...
	ToolTip, %joy_name% (#%JoystickNumber%):`n%axis_info%`nButtons Down: %buttons_down%`nA_Timeidle %A_timeidle%`n phys %a_timeidlephysical%`n(right-click the tray icon to exit)
	Sleep, 100
}
return
esc::exitapp
